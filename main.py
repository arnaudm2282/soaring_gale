...
# %% Small dataset tests - referenced in writeup

# Train small data with Forecaster_fc_hidden model, with a single feature 
#  (Close)
if False:
    etfs_path = './data/ETFs'
    etf_files = os.listdir(etfs_path)
...
# Train the entire ETFs data set with Forecaster_fc_hidden model, with a single
#  feature (Close)
if False:
    etfs_path = './data/ETFs'
    etf_files = os.listdir(etfs_path)
